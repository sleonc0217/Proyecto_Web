...
function mostrarMenu(){
    ...
    <li class="nav-item"><a class="nav-link active" aria-current="page" href="/Proyecto/index.php">Inicio</a></li>
    <li class="nav-item"><a class="nav-link" href="/Proyecto/views/contacto.php">Contáctenos</a></li>
    ...
    <a href="/Proyecto/views/login.php">
    <button class="btnCuenta btn btn-outline-dark" type="submit">
...
function mostarHeader() {
    ...
    <h1 class="display-4 fw-bolder">Compra con estilo</h1>
            <p class="lead fw-normal text-white-50 mb-0">Con las mejores prendas del país</p>
        </div>
        </div>
        </header>
...
function mostarFooter() {

echo '
        <footer class="py-5 bg-dark">
            <div class="container"><p class="m-0 text-center text-white">Copyright &copy; StyleShop 2023</p></div>
        </footer>
